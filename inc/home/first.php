...
<?php if( get_page_template_slug( get_the_ID() ) == '' || get_page_template_slug( get_the_ID() ) == 'page-single.php' ): ?>
        ...
        <article id="post-<?php the_ID(); ?>" class="post col-md-6 col-12 col-lg-12" data-href="<?php the_permalink() ?>" data-class="post">
...
<?php elseif( get_page_template_slug( get_the_ID() ) == 'adv.php' ): ?>
            ...
            <a href="<?php echo $link; ?>" target="_blank" id="post-<?php the_ID(); ?>" class="post col-md-6 col-12 col-lg-12" data-class="post">
